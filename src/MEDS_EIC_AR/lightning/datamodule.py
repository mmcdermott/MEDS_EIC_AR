...
class Datamodule(L.LightningDataModule):
    ...
    After construction, we can access dataloaders for training, validation, and testing:
        ...
        MEDSTorchBatch(code=tensor([[38,  5, 36,  3, 22, 29, 35,  4, 37]]),
                       numeric_value=tensor([[ 0.0000,  0.0000, -6.7254,  0.0000, -0.1190,
                                               0.9995,  0.2792,  0.0000, 0.0000]]),
                       numeric_value_mask=tensor([[False, False,  True, False,  True,
                                                   True,  True, False, False]]),
                       time_delta_days=tensor([[0.0000e+00, 0.0000e+00, 7.6853e+03, 0.0000e+00, 0.0000e+00,
                                                0.0000e+00, 7.9329e-02, 0.0000e+00, 0.0000e+00]]),
                       event_mask=None,
                       static_code=tensor([[ 7, 11]]),
